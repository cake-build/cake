...
public sealed class DotNetPackageListerTests
{
    public sealed class TheListMethod
    {
        ...
        public void Should_Add_Additional_Arguments()
        {
            ...
            // Then
            var expected = "list package --config \"/Working/nuget.config\" --deprecated --framework net10.0 --highest-minor --highest-patch --include-prerelease --include-transitive --interactive --outdated ";
