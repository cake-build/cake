...
public sealed class DotNetPackageAdderTests
{
    public sealed class TheAddMethod
    {
        ...
        public void Should_Add_Additional_Arguments()
        {
            ...
            // Then
            var expected = "add package Microsoft.AspNetCore.StaticFiles --framework net10.0 --interactive --no-restore --package-directory \"/Working/src/project\" --prerelease --source \"http://www.nuget.org/api/v2/package\" --version \"1.0.0\" --verbosity diagnostic";
