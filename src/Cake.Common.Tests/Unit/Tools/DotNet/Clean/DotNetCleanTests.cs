...
using Cake.Common.Tests.Fixtures.Tools.DotNet.Clean;
using Cake.Common.Tools.DotNet.Clean;
using Cake.Testing;

namespace Cake.Common.Tests.Unit.Tools.DotNet.Clean;

public sealed class DotNetCleanTests
{
    public sealed class TheCleanMethod
    {
        ...
        {
            // Given
            var fixture = new DotNetCleanerFixture();
        ...
        public void Should_Throw_If_Project_Is_Null()
        {
            // Given
            var fixture = new DotNetCleanerFixture();
            fixture.Settings = new DotNetCleanSettings();
            fixture.GivenDefaultToolDoNotExist();
