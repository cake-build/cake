...
using Cake.Common.Tests.Fixtures.Tools.VSWhere.Product;
using Cake.Testing;
using Cake.Testing.Xunit;
using Xunit;

namespace Cake.Common.Tests.Unit.Tools.VSWhere.Product
{
    public class VSWhereProductTests
    {
        public sealed class TheProductsMethod
        {
            [Fact]
            ...
            [Fact]
            public void Should_Not_Include_Products_If_Set_To_Empty()
            {
                // Given
                var fixture = new VSWhereProductFixture();
                fixture.Settings.Products = string.Empty;
