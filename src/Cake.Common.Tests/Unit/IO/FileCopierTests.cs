...
public sealed class FileCopierTests
{
    public sealed class FileCopierTestsMethod
    {
        ...
        {
            // When
            var result = Record.Exception(() => FileCopier.CopyFiles(null, [], new DirectoryPath(""), true));
        ...
        public void Should_Throw_If_Target_Directory_Path_Is_Null()
        {
            ...
            // When
            var result = Record.Exception(() => FileCopier.CopyFiles(fixture.Context, [], null, true));
        ...
        public void Should_Throw_If_Target_Directory_Does_Not_Exist()
        {
            ...
            // When
            var result = Record.Exception(() => FileCopier.CopyFiles(fixture.Context, [], new DirectoryPath(dstPath), true));
