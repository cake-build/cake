...
namespace Cake.Common.Tools.DotNet.NuGet.Source
{
    ...
    /// .NET NuGet sourcer.
    /// </summary>
    public sealed class DotNetNuGetSourcer : DotNetTool<DotNetNuGetSourceSettings>
    {
        private readonly ICakeEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the <see cref="DotNetNuGetSourcer" /> class.
        /// </summary>
        /// <param name="fileSystem">The file system.</param>
        /// <param name="environment">The environment.</param>
        /// <param name="processRunner">The process runner.</param>
        /// <param name="tools">The tool locator.</param>
        public DotNetNuGetSourcer(
