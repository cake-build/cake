...
namespace Cake.Common.Tools.WiX
{
    ...
    public sealed class InsigniaRunner : Tool<InsigniaSettings>
    {
        ...
        /// <summary>
        /// Runs Insignia with the specified source files and settings.
        /// </summary>
        /// <param name="sourceFiles">The source files (<c>.wxs</c>) to compile.</param>
        /// <param name="settings">The settings.</param>
        public void Run(IEnumerable<FilePath> sourceFiles, InsigniaSettings settings)
        {
            if (sourceFiles == null)
            {
        ...
        private ProcessArgumentBuilder GetArguments(IEnumerable<FilePath> sourceFiles, InsigniaSettings settings)
        {
            ...
            {
                // Insignia want the path to end with \\, double separator chars.
