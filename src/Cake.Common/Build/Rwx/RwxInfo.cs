...
namespace Cake.Common.Build.Rwx
{
    ...
    public abstract class RwxInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RwxInfo"/> class.
        /// </summary>
        /// <param name="environment">The environment.</param>
        protected RwxInfo(ICakeEnvironment environment)
        {
        ...
        /// </summary>
        /// <param name="variable">The environment variable name.</param>
        /// <returns>The environment variable, or <c>null</c> if it is not set.</returns>
