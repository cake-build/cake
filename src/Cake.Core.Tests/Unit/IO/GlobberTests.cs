...
namespace Cake.Core.Tests.Unit.IO
{
    public sealed class GlobberTests
    {
        ...
        {
            public sealed class WithPatternAndPredicate
            {
                [Fact]
            ...
            public sealed class WithPattern
            {
                public sealed class WindowsSpecific
                {
                    ...
                    public void Should_Ignore_Case_Sensitivity_On_Case_Insensitive_Operative_System(
                        bool isFileSystemCaseSensitive, bool shouldFindFile)
                    {
                        // Given
                        var fixture = new GlobberFixture(windows: !isFileSystemCaseSensitive);
                        var globber = fixture.CreateGlobber();
                ...
                [Fact]
                public void Should_Only_Return_Folders_For_Pattern_Ending_With_Recursive_Wildcard()
                {
                    // Given
                    var fixture = new GlobberFixture();
                    var globber = fixture.CreateGlobber();
                    ...
                    // When
                    var result = globber.Match("/Temp/Hello/**").ToArray();
                ...
                [Fact]
                public void Should_Return_File_For_Pattern_Ending_With_Extension_Regex()
                {
                    // Given
                    var fixture = new GlobberFixture();
                    var globber = fixture.CreateGlobber();
