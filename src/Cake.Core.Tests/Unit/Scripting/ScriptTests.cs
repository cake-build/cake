...
namespace Cake.Core.Tests.Unit.Scripting
{
    public sealed class ScriptTests
    {
        public sealed class TheConstructor
        {
            ...
            {
                // Given, When
                var script = new Script(null, new string[] { }, new ScriptAlias[] { }, new string[] { }, new string[] { });
            ...
            {
                // Given, When
                var script = new Script(new string[] { }, null, new ScriptAlias[] { }, new string[] { }, new string[] { });
            ...
            {
                // Given, When
                var script = new Script(new string[] { }, new string[] { }, null, new string[] { }, new string[] { });
            ...
            {
                // Given, When
                var script = new Script(new string[] { }, new string[] { }, new ScriptAlias[] { }, null, new string[] { });
            ...
            {
                // Given, When
                var script = new Script(new string[] { }, new string[] { }, new ScriptAlias[] { }, new string[] { }, null);
