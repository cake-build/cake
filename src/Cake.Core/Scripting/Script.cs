...
public sealed class Script
{
        ...
        IEnumerable<string> defines)
    {
        ...
        Aliases = new List<ScriptAlias>(aliases ?? []);
        UsingAliasDirectives = new List<string>(usingAliasDirectives ?? []);
        UsingStaticDirectives = new List<string>(usingStaticDirectives ?? []);
